...
<div class="background">
    <img src="assets/Republic_Assault.png" id="s1" style="opacity:1;transition:all 0.5s;"><!--Change your background url here (image located in assets folder) SLIDE 1-->
</div>
...
<!--Change your background url here (image located in assets folder)-->
    ...
    <div class="content_card">
        <div class="infos">
            <h1>Infos</h1>
            <li id="srvdis"><img id="icsvn" src="assets/servername.png"> <span id="Merix Gaming">Server</span></li>
            <li id="gmdis"><img id="icgm" src="assets/games.png"> <span id="starwarsrp">Gamemode</span></li>
            <li id="mapdis"><img id="icmap" src="assets/maps.png"> <span id="rp_venator_v3">Map</span></li>
            <li id="sldis"><img id="icslo" src="assets/slots.png"> <span><span style="margin-left:0;" id="50">nbr</span> Slots</span></li>
    ...
    <audio class='audio' autoplay src="" onloadstart="this.volume=0.1"></audio><!--0.1 = 10%, 0.2 = 20%,... / SONG VOLUME-->
